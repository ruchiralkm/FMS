...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_FILES['picture']['name'])) {
        ...
        $picture = $target_file;
        $sql = "UPDATE support_team SET fname='$fname', lname='$lname', address ='$address', dlno='$dlno', mobile='$mobile', dob='$dob', email='$email', password='$password', position='$position', picture='$picture' WHERE dlno='$dlno'";
    } else {
        $sql = "UPDATE support_team SET fname='$fname', lname='$lname', address ='$address', dlno='$dlno', mobile='$mobile', dob='$dob', email='$email', password='$password', position='$position' WHERE dlno='$dlno'";
    }
...
$sql = "SELECT * FROM support_team WHERE dlno='$dlno'";
...
<div class="editContainer">
    <header class = "header">Update Support Team Information</header>
